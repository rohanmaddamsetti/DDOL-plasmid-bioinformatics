...
This script combines all MOB-typer results into a single .csv file.
"""
...
with open('../results/combined_mob_typer_results.txt','w',newline='') as txt_file):
	...
	# Iterate through each '.txt' file in the data directory (plasmid-MOB-typer-results/)
	for path in glob.glob("../plasmid-MOB-typer-results/*results.txt"):
		with open("../plasmid-MOB-typer-results/"+path, 'r') as txt_input_file:
